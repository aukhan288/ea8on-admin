...
$(document).ready(function() {
  var table = $('#usersTable').DataTable({
    ...
    stateSave: true,
    "ajax": {
      "url": "/public/admin/delivery-boyList/",
      "type": "GET",
    ...
    "columns": [
      { 'title': 'Name', "data": "", 
        ...
        return `<span style="padding: 5px; background-color: ${row?.a_status?'green':'red'}; border-radius: 50%; display: inline-block; width: 10px; height: 10px;"></span>
        ${row?.name}`;
        }
      },
      // { 'title': 'Email', "data": "email" },
      { 'title': 'Contact #', "data":"mobile"},
      { 'title': 'Actions',
        "data": null,
        "render": function(data, type, row) {
          return `
